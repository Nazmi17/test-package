                ...
                <div x-show="openFilter" x-transition x-cloak style="display: none;" class="absolute right-0 mt-2 w-64 bg-white border border-gray-200 rounded-xl shadow-lg z-50 p-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input wire:model.live="date_from" type="date" class="w-full border px-3 py-2 rounded-lg bg-gray-50 text-sm focus:ring-2 focus:ring-green-200 outline-none">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-600 mb-1">Sampai Tanggal</label>
                            <input wire:model.live="date_to" type="date" class="w-full border px-3 py-2 rounded-lg bg-gray-50 text-sm focus:ring-2 focus:ring-green-200 outline-none">
                        </div>
                    </div>
                </div>
            </div>
