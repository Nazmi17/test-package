            ...
            <div class="hidden lg:block">
                <form>
                    <div class="relative">
                        ...
                        <input
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 focus:ring-3 focus:outline-hidden h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 placeholder:text-gray-400 xl:w-[430px] dark:border-gray-800 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30"
                            id="search-input"
                            type="text"
            ...
            <div class="2xsm:gap-3 flex items-center gap-2">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <span
                                class="-z-1 absolute inline-flex h-full w-full animate-ping rounded-full bg-orange-400 opacity-75"
                            ></span>
                        </span>
                        <svg
                            class="fill-current"
                    ...
                    >
                        ...
                        <ul class="custom-scrollbar flex h-auto flex-col overflow-y-auto">
                            <li>
                                <a
                                    class="px-4.5 flex gap-3 rounded-lg border-b border-gray-100 p-3 py-3 hover:bg-gray-100 dark:border-gray-800 dark:hover:bg-white/5"
                                    href="#"
                                >
                                    <span class="z-1 relative block h-10 w-full max-w-10 rounded-full">
                                        <img
                                            class="overflow-hidden rounded-full"
                                            src="{{ asset('assets/images/user/user-01.jpg') }}"
                                            alt="User"
                                        />
                                        <span
